	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float3 uv_StarsCubemap4223 = i.ase_texcoord1.xyz;
				float4 texCUBENode422 = texCUBE( _StarsCubemap, uv_StarsCubemap4223 );
				...
				float2 appendResult719 = (float2(WorldPosition.x , WorldPosition.z));
				float2 temp_output_840_0 = ( ( appendResult719 / ( WorldPosition.y * _CloudHeight ) ) / _CloudTiling );
				float mulTime829 = _Time.y * _CloudTimescale;
				float2 appendResult763 = (float2(WorldPosition.x , WorldPosition.z));
				float mulTime835 = _Time.y * _CloudTimescale;
				float CoverageGradient915 = (( _UseRadialCoverageMask )?( saturate( 0.0 ) ):( _CloudCoverage ));
				float CloudCoverage896 = (-1.0 + (CoverageGradient915 - 0.0) * (1.0 - -1.0) / (1.0 - 0.0));
				float smoothstepResult1039 = smoothstep( _CloudSharpness.x , _CloudSharpness.y , ( ( ( tex2D( _CloudNoise, ( temp_output_840_0 + ( _CloudOffset + ( _CloudScroll * mulTime829 ) ) ) ).r + tex2D( _CloudNoise, ( temp_output_840_0 + ( mulTime829 * _CloudScroll2 ) + _CloudOffset2 ) ).r + tex2D( _CloudNoise, ( ( appendResult763 / ( WorldPosition.y * _CloudHeight3 ) ) + ( _CloudScroll3 * mulTime835 ) ) ).r ) / 3.0 ) + CloudCoverage896 ));
				float3 normalizeResult722 = normalize( WorldPosition );
...
/*ASEBEGIN
Version=18000
7;29;1906;982;1334.034;2584.543;1.486327;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;714;-6157.41,554.8444;Float;False;Property;_CloudHeight;Cloud Height;38;0;Create;True;0;0;False;0;0;37.9;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;711;-6146.866,354.9651;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;846;-5636.214,899.9142;Float;False;Property;_CloudTimescale;Cloud Timescale;34;0;Create;True;0;0;False;0;0;0.01;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;764;-5590.624,1230.537;Float;False;Property;_CloudHeight3;Cloud Height 3;44;0;Create;True;0;0;False;0;0;-4.86;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;828;-4636.426,449.1328;Float;False;Property;_CloudScroll;Cloud Scroll;41;0;Create;True;0;0;False;0;0,0;0.4,0.1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.CommentaryNode;205;-4298.641,-2301.435;Inherit;False;2704.589;737.7334;Comment;39;939;933;71;18;69;298;303;261;264;297;302;263;287;262;300;265;75;286;271;268;282;281;284;252;285;200;12;34;11;10;942;947;951;950;952;953;956;958;959;Sun Disk;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;745;-8135.004,1122.672;Float;False;Property;_CloudCoverage;Cloud Coverage;32;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;1030;-4982.977,814.4601;Float;False;Property;_CloudScroll2;Cloud Scroll 2;43;0;Create;True;0;0;False;0;2,0;0.3,-0.2;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.CommentaryNode;199;-975.0939,-2287.015;Inherit;False;2101.376;1153.238;Comment;34;79;197;78;561;84;56;560;85;81;92;91;235;86;562;563;564;565;566;567;568;569;570;571;573;574;575;576;577;578;579;1068;1069;1070;1071;Sky Color Base;1,1,1,1;0;0
Node;AmplifyShaderEditor.ToggleSwitchNode;1064;-6730.66,971.8688;Float;False;Property;_UseRadialCoverageMask;Use Radial Coverage Mask;53;0;Create;True;0;0;False;0;0;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;710;-4650.128,333.1281;Float;False;Property;_CloudOffset;Cloud Offset;40;0;Create;True;0;0;False;0;0,0;14.1,8.24;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;841;-5666.073,555.9088;Float;False;Property;_CloudTiling;Cloud Tiling;39;0;Create;True;0;0;False;0;0,0;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;834;-5361.412,1363.614;Float;False;Property;_CloudScroll3;Cloud Scroll 3;45;0;Create;True;0;0;False;0;0,0;0,0.1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;10;-4259.322,-1879.032;Inherit;False;False;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.Vector2Node;1033;-4925.894,952.7032;Float;False;Property;_CloudOffset2;Cloud Offset 2;42;0;Create;True;0;0;False;0;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;86;-872.9777,-1295.742;Float;False;Property;_NightTransitionScale;Night Transition Scale;18;0;Create;True;0;0;False;0;1;7.84;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;21;-8454.089,-2150.497;Float;False;Property;_HorizonSunGlowSpreadMax;Horizon Sun Glow Spread Max;16;0;Create;True;0;0;False;0;0;3.77;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;20;-8444.089,-2239.498;Float;False;Property;_HorizonSunGlowSpreadMin;Horizon Sun Glow Spread Min;14;0;Create;True;0;0;False;0;5.075109;0;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;728;-5779.462,-230.0381;Float;False;Property;_CloudHorizonMaskHeightOffset;Cloud Horizon Mask Height Offset;36;0;Create;True;0;0;False;0;0;0.02;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;285;-4261.198,-2021.038;Float;False;Property;_SunDiskSizeAdjust;Sun Disk Size Adjust;10;0;Create;True;0;0;False;0;0;0.00107;0;0.01;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;754;-4293.238,994.8459;Float;True;Property;_CloudNoise;Cloud Noise;37;0;Create;True;0;0;False;0;None;None;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.RangedFloatNode;252;-4255.772,-2252.467;Float;False;Property;_SunDiskSize;Sun Disk Size;9;0;Create;True;0;0;False;0;0;0;0;0.5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;726;-5530.962,-127.7393;Float;False;Property;_CloudHorizonMaskSharpness;Cloud Horizon Mask Sharpness;35;0;Create;True;0;0;False;0;0;11.13;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;281;-3985.405,-1873.9;Float;False;Property;_SunDiskSharpness;Sun Disk Sharpness;11;0;Create;True;0;0;False;0;0;0.0093;0;0.01;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;243;-4238.763,-2528.84;Float;False;Property;_NightTransitionHorizonDelay;Night Transition Horizon Delay;19;0;Create;True;0;0;False;0;0;-4.77;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;527;-3893.45,-754.1828;Float;False;Property;_StarLayer3Intensity;Star Layer 3 Intensity;25;0;Create;True;0;0;False;0;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;525;-3903.935,-921.3803;Float;False;Property;_StarLayer1Intensity;Star Layer 1 Intensity;23;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;422;-3907.76,-1134.019;Inherit;True;Property;_StarsCubemap;Stars Cubemap;15;1;[NoScaleOffset];Create;True;0;0;False;0;-1;None;77520064aae579b48aa2e3d446f8c536;True;0;False;white;LockedToCube;False;Object;-1;Auto;Cube;6;0;SAMPLER2D;;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;526;-3897.919,-837.9351;Float;False;Property;_StarLayer2Intensity;Star Layer 2 Intensity;24;0;Create;True;0;0;False;0;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;568;-903.3739,-2062.666;Float;False;Property;_SkyGradientPower;Sky Gradient Power;7;0;Create;True;0;0;False;0;0;2.76;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;1040;-3036.617,603.4046;Float;False;Property;_CloudSharpness;Cloud Sharpness;48;0;Create;True;0;0;False;0;0,0;0.4,0.44;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;570;-906.5739,-1984.266;Float;False;Property;_SkyGradientScale;Sky Gradient Scale;8;0;Create;True;0;0;False;0;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;244;-1862.364,-2563.768;Float;False;Property;_HorizonMinAmountAlways;Horizon Min Amount Always;20;0;Create;True;0;0;False;0;0;0.238;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;531;-3538.435,-751.5916;Float;False;Property;_StarSize;Star Size;26;0;Create;True;0;0;False;0;0,0,0;7.6,10,40.6;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.PowerNode;532;-3166.898,-992.7679;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;428;-3176.359,-1086.607;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;533;-3190.185,-887.9802;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;46;-7738.571,-2640.74;Float;False;Property;_HorizonSharpness;Horizon Sharpness;13;0;Create;True;0;0;False;0;5.7;5.38;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;17;-7094.485,-2206.375;Float;False;Property;_HorizonGlowIntensity;Horizon Glow Intensity;12;0;Create;True;0;0;False;0;0.59;1.69;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;79;-911.0458,-1887.826;Float;False;Property;_NightColorTop;Night Color Top;5;0;Create;True;0;0;False;0;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;577;-917.1683,-1673.77;Float;False;Property;_NightColorBottom;Night Color Bottom;6;0;Create;True;0;0;False;0;0,0,0,0;0.03302112,0.004004983,0.1698068,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LightColorNode;18;-2507.354,-2008.118;Inherit;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;939;-2325.773,-1957.965;Float;False;Property;_SunDiskIntensity;Sun Disk Intensity;46;0;Create;True;0;0;False;0;0;3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;574;-17.86925,-1886.846;Float;False;Property;_SkyColorBottom;Sky Color Bottom;3;0;Create;True;0;0;False;0;0.3764706,0.6039216,1,0;0.2782971,0.8399825,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;56;-3.628321,-2063.511;Float;False;Property;_SkyColorTop;Sky Color Top;1;0;Create;True;0;0;False;0;0.3764706,0.6039216,1,0;0.1200091,0.3730537,0.8207547,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;958;-2444.473,-2238.817;Float;False;Property;_SunDiskCloudsTransmissionIntensity;Sun Disk Clouds Transmission Intensity;47;0;Create;True;0;0;False;0;0;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;942;-2332.729,-1739.246;Inherit;False;694;CloudLayer;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;71;-2307.674,-2102.25;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;959;-2142.145,-2235.793;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;933;-2109.753,-2041.923;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ColorNode;57;-6194.929,-2758.385;Float;False;Property;_HorizonColor;Horizon Color;4;0;Create;True;0;0;False;0;0.9137255,0.8509804,0.7215686,0;1,0.7776151,0.5990566,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;950;-1927.105,-2120.911;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.ColorNode;768;-6768.711,-3237.574;Float;False;Property;_CloudColor;Cloud Color;33;0;Create;True;0;0;False;0;0,0,0,0;0.740566,0.9247342,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;951;-1730.199,-2062.338;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;291;-6073.199,-2050.299;Float;False;Property;_HorizonTintSunPower;Horizon Tint Sun Power;17;0;Create;True;0;0;False;0;0;3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;590;-2814.352,-80.63311;Half;False;Property;_FogFill;Fog Fill;30;0;Create;True;0;0;False;0;0.5;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;595;-4222.352,-80.63311;Half;False;Property;_FogSmoothness;Fog Smoothness;31;0;Create;True;0;0;False;0;0.01;0.122;0.01;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;589;-3006.352,-400.6332;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;548;-3895.038,-1211.974;Float;False;Property;_GalaxyItensity;Galaxy Itensity;28;0;Create;True;0;0;False;0;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1071;561.1963,-1707.05;Inherit;False;573;SkyColorGradient;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;1070;880.4119,-1723.077;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;907;-8146.591,1000.919;Float;False;Property;_CoverageGradientSize;Coverage Gradient Size;51;0;Create;True;0;0;False;0;0;360.27;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;534;-4148.789,-1081.969;Inherit;False;RotateCubemap2D;-1;;17;75cba96657f42e942962c7bf20605826;0;0;0
...
Node;AmplifyShaderEditor.Vector2Node;509;-4943.953,-1153.525;Float;False;Property;_StarRotation;Star Rotation;21;0;Create;True;0;0;False;0;0,0;99,184.43;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;510;-4955.792,-938.8622;Float;False;Property;_StarRotationSpeed;Star Rotation Speed;22;0;Create;True;0;0;False;0;0,0;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.FunctionNode;900;-7306.607,801.3922;Inherit;False;RadialGradient;-1;;16;dfd553b6313c07d44b9845c03b277cad;0;0;0
Node;AmplifyShaderEditor.ColorNode;1069;578.0141,-2062.628;Float;False;Property;_TransitionColorTop;Transition Color Top;0;0;Create;True;0;0;False;0;0.3764706,0.6039216,1,0;0.1200091,0.3730537,0.8207547,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;929;-7811.062,1178.395;Float;False;Property;_CoverageGradientSharpness;Coverage GradientSharpness;52;0;Create;True;0;0;False;0;0;0.01;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;906;-7713.96,846.6306;Float;False;Property;_CoverageGradientOffset;Coverage Gradient Offset;50;0;Create;True;0;0;False;0;0,0;9.48,5.07;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;904;-8200.08,886.4998;Float;False;Property;_CoverageGradientHeight;Coverage Gradient Height;49;0;Create;True;0;0;False;0;0;-0.24;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;535;-4142.435,-1219.065;Inherit;False;RotateCubemap2D;-1;;19;75cba96657f42e942962c7bf20605826;0;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;594;-4222.352,-208.6332;Half;False;Property;_FogHeight;Fog Height;29;0;Create;True;0;0;False;0;1;0.624;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;536;-3887.185,-1415.429;Inherit;True;Property;_StarSkyCubemap;Star Sky Cubemap;27;0;Create;True;0;0;False;0;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Cube;6;0;SAMPLER2D;;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;1068;467.7732,-1904.963;Float;False;Property;_TransitionColorBottom;Transition Color Bottom;2;0;Create;True;0;0;False;0;0.3764706,0.6039216,1,0;0.2782971,0.8399825,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=A208AFF857972459A268D1E5D4F0374FFD2A00CE